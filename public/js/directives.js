...
angular.module('myApp.directives', []).
	...
	return {
		...
		ngModel.$asyncValidators.usernameAvailable = function(username) {
		    return $http.get('/api/username-exists?='+ username);
		};
	    }
	}
    }]);
...
angular.module('myColorPicker', []).directive('uiColorpicker', function() {
    return {
        restrict: 'E',
        require: 'ngModel',
        scope: false,
...
angular.module('myModal', []).directive('modal', function () {
    return {
